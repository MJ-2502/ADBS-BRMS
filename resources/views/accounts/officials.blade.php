...
<div class="flex flex-wrap items-center justify-between gap-4">
    <div>
        ...
        <h1 class="text-xl font-semibold text-slate-800 dark:text-white">Official accounts</h1>
...
<div class="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-800/50">
        <table class="w-full text-sm">
            ...
            <tbody>
                            ...
                            <td class="px-4 py-3 text-right">
                                ...
                                <div class="inline-flex items-center gap-2">
                                    ...
                                    @else
                                        ...
                                        <form method="POST" action="{{ route('accounts.officials.destroy', $official) }}" class="inline" onsubmit="return confirm('Delete this official account?');">
                                            @csrf
                                            @method('DELETE')
                ...
                @empty
                    <tr>
                            <td colspan="6" class="px-4 py-8 text-center text-slate-500 dark:text-slate-400">No official accounts yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
