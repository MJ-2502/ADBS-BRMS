...
<div class="mb-6">
    ...
    <p class="mt-1 text-sm text-slate-400">Sign in to access your account</p>
</div>
    ...
    <div class="space-y-2">
        ...
        <div class="input-group">
            ...
            <input 
                ...
                name="email" 
                value="{{ old('email') }}" 
                class="input-with-icon w-full rounded-lg border border-slate-700 px-3 py-3 text-base transition-all duration-200 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-200" 
    ...
    <div class="space-y-2">
        ...
        <div class="input-group">
            ...
            <input 
                ...
                name="password" 
                id="password" 
                class="input-with-icon w-full rounded-lg border border-slate-700 px-3 py-3 pr-12 text-base transition-all duration-200 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-200" 
    ...
    <div class="flex items-center justify-between text-sm">
        <label class="inline-flex items-center gap-2 cursor-pointer">
            <input 
                ...
                name="remember" 
                value="1" 
                class="h-4 w-4 rounded border-slate-700 text-emerald-600 focus:ring-2 focus:ring-emerald-200 transition-all"
            >
            <span class="text-slate-300">Remember me</span>
        </label>
        <div class="flex items-center gap-4">
            <a href="{{ route('password.request') }}" class="font-semibold text-slate-400 hover:text-slate-200 transition-colors">
                Forgot password?
            </a>
